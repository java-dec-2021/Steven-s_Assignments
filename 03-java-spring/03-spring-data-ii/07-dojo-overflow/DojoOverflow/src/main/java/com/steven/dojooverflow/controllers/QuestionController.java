package com.steven.dojooverflow.controllers;
...
import com.steven.dojooverflow.services.DojoOverflowService;

@Controller
public class QuestionController {
	private final DojoOverflowService service;
	public QuestionController(DojoOverflowService service) {
